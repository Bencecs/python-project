import cmath
print("FONTOS! A program csak 0-ra végződő egyenleteket tud megoldani")
...
def save_to_file(content, filename="megoldasok.txt"):
...
def main():
    ...
    if equation_type == "1":
        ...
        save_to_file(f"Elsőfokú egyenlet: {equation}, Megoldás: {result}")
        ...
        save_to_file(f"Másodfokú egyenlet: {equation}, Gyökök: {roots[0]} és {roots[1]}")
